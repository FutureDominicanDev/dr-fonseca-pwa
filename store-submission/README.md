...
- iOS: Capacitor/WKWebView shell. Apple is stricter with apps that look like simple website wrappers, so the iOS shell should include a branded launch screen, camera/microphone/file permission handling, app review notes, and links to privacy, support, account deletion, and the icon legend.
...
- Account deletion, privacy, support, and icon legend pages open from the app.
